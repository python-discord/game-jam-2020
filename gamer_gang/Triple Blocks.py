...
class MyGame(arcade.Window):
    ...
    def start_new_game(self):
        ...
        self.physics_engines.append(arcade.PhysicsEnginePlatformer(self.player_sprite_list[0], self.ground_sprite_list,
    ...
    def on_update(self, x):
        ...
        self.player_sprite_list[self.selected_player].change_x += self.player_sprite_list[
            self.selected_player].acc_x if abs(self.player_sprite_list[self.selected_player].change_x) < 3.5 else 0
        self.player_sprite_list[self.selected_player].change_y = self.key_pressed[2] if self.physics_engines[
            self.selected_player].can_jump() else self.player_sprite_list[self.selected_player].change_y
        ...
        if self.key_pressed[0] + self.key_pressed[1] == 0:
            if abs(self.player_sprite_list[self.selected_player].change_x) < 0.4:
                ...
                self.player_sprite_list[self.selected_player].change_x += 0.3 if self.player_sprite_list[
                                                                                     self.selected_player].change_x < 0 else -0.3
