...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        for y in range(-64, -500, -128):
            for x in range(-6400, 64000, 128):
    ...
    def on_update(self, delta_time):
        ...
        # self.view_left = self.view_left - Maths.smoothstep(0, 1, 0.25) * (self.view_left - self.player_sprite.center_x - SCREEN_WIDTH / 2)
